...
%
% This file contains the reference TikZ commands to draw the metsymb symbol: SIX_OKTAS
%
% Reference: n/a
%
...
\draw (0.075, 0.55) -- (0.5, 0.55) -- (0.5, 0.975);
\fill [black] (0.5, 0.55) -- (0.5, 0.975) arc (90:-180:0.425) -- cycle;
