...
%
% This file contains the reference TikZ commands to draw the metsymb symbol: THREE_OKTAS
%
% Reference: n/a
%
...
\draw (0.5, 0.55) -- (0.925, 0.55);
\fill [black] (0.5, 0.55) -- (0.5, 0.975) arc (90:0:0.425) -- cycle;
