...
%
% This file contains the reference TikZ commands to draw the metsymb symbol: FIVE_OKTAS
%
% Reference: n/a
%
% Created 04.09.2022; frederic.vogt@meteoswiss.ch
...
\draw  (0.5, 0.55) circle (0.425);
\draw (0.075, 0.55) -- (0.5, 0.55);
\draw (0.5, 0.125) -- (0.5, 0.975);
\fill [black] (0.5, 0.55) -- (0.5, 0.975) arc (90:-90:0.425) -- cycle;
