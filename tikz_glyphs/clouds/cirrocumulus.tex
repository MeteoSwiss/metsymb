...
\draw ({0.075}, {0.55 - tan(\pa)*(0.425-\ra + sin(\pa)*\ra) - cos(\pa)*\ra}) arc (+180:+90+\pa:\ra) -- ({0.925-\ra + sin(\pa)*\ra}, {0.55 + tan(\pa)*( 0.425-\ra + sin(\pa)*\ra)}) arc (-90+\pa:+15:\ra);
\draw ({0.075}, {0.55 - tan(\pa) * (0.5-0.075-\ra + sin(\pa)*\ra) - cos(\pa) * \ra}) arc (+180:+195:\ra);
