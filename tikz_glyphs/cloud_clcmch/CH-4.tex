...
%
% This file contains the reference TikZ commands to draw the metsymb symbol: cloud CH-4
%
...
\draw (0.075, 0.125) -- ({0.925-\ra+sin(\pa)*\ra}, {0.125 + tan(\pa) * (0.925-0.075-\ra+sin(\pa)*\ra)}) arc (-90+\pa:+115:\ra);
