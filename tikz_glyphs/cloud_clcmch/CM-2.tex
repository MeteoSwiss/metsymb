...
%
% This file contains the reference TikZ commands to draw the metsymb symbol: cloud CM-2
%
...
\draw [join=round] (0.95, 0.125) -- (0.075, 0.125) -- (0.95, {0.125 + tan(\pa) * 0.875});
\draw (0.325, 0.125) -- (0.95, {0.125 + tan(\pa)*0.625});
