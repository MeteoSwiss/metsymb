...
%
% This file contains the reference TikZ commands to draw the metsymb symbol: cloud CH-7
%
...
\draw [join=round] (0.55, 0.125) -- (0.075, 0.125) -- (0.325, {0.125 + tan(\pa) * 0.25}) arc (-90+\pa:+115:\ra);
\draw [join=round] (0.55, 0.125) -- (0.925, 0.125) -- (0.675, {0.125 + tan(\pa) * 0.25}) arc (+270-\pa:+65:\ra);
