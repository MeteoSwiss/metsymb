...
%
% This file contains the reference TikZ commands to draw the metsymb symbol: cloud CL-9
%
...
\draw (0.075, 0.1) arc (+180:0:0.425);
\draw ({0.5 - sin(25) * 0.425}, {0.1 + 0.425 * cos(25)}) -- (0.15, 0.75) -- (0.85, 0.75) --  ({0.5+sin(25)*0.425}, {0.1+0.425*cos(25)});
\draw (0.075, 0.125) -- (0.925, 0.125);
