...
%
% This file contains the reference TikZ commands to draw the metsymb symbol: cloud CH-9
%
...
%\draw [red] (0.025,0.025) rectangle (0.975, 1.25) (0,0.075) -- (1,0.075);
...
\draw (0.925, 0.35) arc (0:-180:0.2125) arc (0:-180:0.2125) -- (0.625, {0.35 + tan(\pa) * 0.55}) arc (-90+\pa:+115:\ra);
