...
%
% This file contains the reference TikZ commands to draw the metsymb symbol: cloud CL-4
%
...
\centerarc[](0.5, 0.55 - \gap /2)(+180:0:\ra*1.4)
\draw  (0.05, 0.55 - \gap / 2) -- (0.5-\ra, 0.55 - \gap / 2) arc (-170:-10:\ra)  -- (0.95, 0.55 - \gap / 2);
