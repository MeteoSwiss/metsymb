...
%
% This file contains the reference TikZ commands to draw the metsymb symbol: cloud CM-9
%
% Reference: https://cloudatlas.wmo.int/en/cloud-symbols-corresponding-to-codes-cl-cm-ch.html
%
% Created 07.10.2022; frederic.vogt@meteoswiss.ch
...
\def\pa{33}
% Ratio of the small radius to the big one
\def\smallra{0.55}
...
\draw ({0.5-0.2125*(1-\smallra)}, 0.35) arc (0:-180:{0.2125 * \smallra}) -- (0.85, {0.35 + tan(\pa) * (0.85 - (0.075 + 0.2125 * (1-\smallra)))});
\draw (0.5, 0.35) arc (0:-180:0.2125);
