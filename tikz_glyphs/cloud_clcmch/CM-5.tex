...
%
% This file contains the reference TikZ commands to draw the metsymb symbol: cloud CM-5
%
...
\draw (0.925, 0.35) arc (0:-180:0.2125) arc (0:-180:0.2125) -- (0.95, {0.35 + tan(\pa) * 0.875});
