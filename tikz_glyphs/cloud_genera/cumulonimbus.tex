...
%
% This file contains the reference TikZ commands to draw the metsymb symbol: CUMULONIMBUS
%
...
%\draw (0.5 - sin(30) * 0.425, 0.425 * cos(30)) -- (0.15, 0.7) -- (0.85, 0.7) -- (0.5+sin(30)*0.425, 0.425*cos(30));
