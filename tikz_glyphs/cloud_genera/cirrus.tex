...
%
% This file contains the reference TikZ commands to draw the metsymb symbol: CIRRUS
%
...
% Modified 07.10.2022; frederic.vogt@meteoswiss.ch - added a unique ra definition for the curves
...
\draw  (0.05, 0.55) -- (0.925-\ra, 0.55) arc (-90:+75:\ra) (0.925-\ra, 0.55) arc (+90:-75:\ra);
