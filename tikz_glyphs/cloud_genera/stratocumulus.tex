...
%
% This file contains the reference TikZ commands to draw the metsymb symbol: STRATOCUMULUS
%
...
% Modified 07.10.2022; frederic.vogt@meteoswiss.ch - Set a radius to match the cumulus bump
